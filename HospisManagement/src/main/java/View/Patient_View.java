...
public class Patient_View extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Patient p=new Patient(nom , prenom, age, sexe, adresse);
    ...
    public void remplir(){
        ...
        //creation de collones du tableau
        dtm.addColumn("codeP");
        dtm.addColumn("nom");
        ...
        rs=pa.Patient_Liste();
            try {
                while(rs.next()){
                   ...
                   Object[] ob={codeP,nom,prenom,age,sexe,adresse};
                    dtm.addRow(ob);
               }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String sexe=jTextField5.getText();
        String adresse=jTextField6.getText();
        Patient p=new Patient(codeP,nom,prenom,age,sexe,adresse);
        Patient_Actions pa=new Patient_Actions();
        pa.Patient_Update(p);
        JOptionPane.showConfirmDialog(null, "le patient a ete modifié");
        jTextField1.setText("");
        jTextField2.setText("");
        jTextField3.setText("");
        jTextField4.setText("");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        Patient p=null;
        Patient_Actions pa=new Patient_Actions();
        p=pa.Patient_Find(codeP);
        if(p==null){
            JOptionPane.showMessageDialog(null, "aucun patient trouvé");
        }
        else{
        Integer x=p.getCodeP();
        String a =x.toString();
        jTextField1.setText(a);
        jTextField2.setText(p.getNom());
        jTextField3.setText(p.getPrenom());
        jTextField4.setText(p.getAge());
        jTextField5.setText(p.getSexe());
        jTextField6.setText(p.getAdresse());
